			...
			>
				<FormRow textStyle={{color: '#fff'}}
					...
					<Switch
						...
						thumbColor={startWithAudioMuted ? THUMB_COLOR : 'white'}
						trackColor={{true: palette.efcoSwitchTrackColor, false: 'grey'}}
						// trackColor={{true: palette.efcoSwitchTrackColor}}
					/>
				</FormRow>
				...
				>
					<Switch
						...
						thumbColor={startWithVideoMuted ? THUMB_COLOR : 'white'}
						trackColor={{true: palette.efcoSwitchTrackColor, false: 'grey'}}

						// trackColor={{true: palette.screen01Header}}
						value={startWithVideoMuted}/>
				</FormRow>
				<FormRow textStyle={{color: '#CACACA'}}
							accordion={false}
							expandable={false}
